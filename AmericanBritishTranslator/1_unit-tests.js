...
suite('Unit Tests', () => {
    ...
    suite("Translate to American English", function() {
        ...
        test("Translate Have you met Mrs Kaylani? to American English", function(done) {
            assert.equal(
                translator.toAmericanEnglish("Have you met Mrs Kaylani?")[0],
                "Have you met Mr.s Kaylani?"
            );
            done();
        });
    ...
    suite("Highlight Translation", function() {
        test("Highlight tanslation in Mangoes are my favorite fruit.", function(done) {
            assert.equal(
        ...
        test("Highlight tanslation in I ate yogurt for breakfast.", function(done) {
            assert.equal(
        ...
        test("Highlight tanslation in We watched the footie match for a while.", function(done) {
            assert.equal(
        ...
        test("Highlight tanslation in Paracetamol takes up to an hour to work.", function(done) {
            assert.equal(
